    ...
    def _prepare_memory_conditioned_features(
        ...
        if not is_init_cond_frame and use_prev_mem_frame:
            ...
            for t_pos, prev, is_selected_cond_frame in t_pos_and_prevs:
                ...
                feats = prev["maskmem_features"].to("cuda" if torch.cuda.is_available() else "cpu", non_blocking=True)
                ...
                maskmem_enc = prev["maskmem_pos_enc"][-1].to("cuda" if torch.cuda.is_available() else "cpu")
